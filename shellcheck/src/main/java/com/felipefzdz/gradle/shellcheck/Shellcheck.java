...
@CacheableTask
public abstract class Shellcheck extends ConventionTask implements VerificationTask {
    ...
    public Shellcheck() {
        this.reports = (ShellcheckReports) getObjectFactory().newInstance(ShellcheckReportsImpl.class);
    }
